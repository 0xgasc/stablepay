...
const CHAIN_RPC: Record<string, { rpc: string; tokens: Record<string, string>; native: string }> = {
  ...
  BNB_MAINNET: { rpc: process.env.BNB_MAINNET_RPC_URL || 'https://bsc-dataseed.binance.org', native: 'BNB', tokens: { USDC: '0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d', USDT: '0x55d398326f99059fF775485246999027B3197955' } },
};
